...
1. **claude-features/{feature_name}/plan.md** — change [ ] to [x] for Phase {phase_number} in the checklist
2. **claude-features/{feature_name}/phases/phase_{phase_number}.md** — change [ ] to [x] for each completed item
