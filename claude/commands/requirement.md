...
Your ONLY output from this command is: claude-features/$ARGUMENTS/requirement.md (and updates to brainstorm.md if needed)
...
You are creating requirements for feature: $ARGUMENTS
...
3. Then write it to: claude-features/$ARGUMENTS/requirement.md
...
After writing the file, remind me to run /compact, then /review-requirement $ARGUMENTS when ready.
