...
Your ONLY output from this command is: claude-features/$ARGUMENTS/brainstorm.md
You do NOT write any code. You do NOT create any other files. You do NOT start on requirements, design, or implementation.

---

You are starting the brainstorming phase for feature: $ARGUMENTS
...
3. Then write it to: claude-features/$ARGUMENTS/brainstorm.md
...
- Do NOT read or parse conversation log files, JSONL files, or any internal Claude data files — if you've lost context, ask me to re-summarize

After writing the file, remind me to run /compact, then /review-brainstorm $ARGUMENTS when ready.
